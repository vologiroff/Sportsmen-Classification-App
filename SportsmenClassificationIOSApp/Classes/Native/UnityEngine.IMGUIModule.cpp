...
IL_0071:
	{
		...
		int32_t L_23 = ___id1;
		NullCheck(L_22);
		WindowFunction_Invoke_mF7D36482F583383AF583ED812A4E2487C06C3748(L_22, L_23, /*hidden argument*/NULL);
		Event_tED49F8EC5A2514F6E877E301B1AB7ABE4647253E * L_24 = Event_get_current_m069E3E742E6CBC32C3BC958B85153E75B0192443(/*hidden argument*/NULL);
		NullCheck(L_24);
		int32_t L_25 = Event_get_type_mA5010AB8C34B098E0783949046C708B9E1BA811D(L_24, /*hidden argument*/NULL);
...
IL_009b:
	{
		GUISkin_tE353D65D4618423B574BAD31F5C5AC1B967E32C6 * L_27 = V_0;
		IL2CPP_RUNTIME_CLASS_INIT(GUI_tBCBBE29117D8093644C6E72B1CE3FB65C2CDCCC1_il2cpp_TypeInfo_var);
		GUI_set_skin_mFCD039C47B3C327D9E0D867092DB353F2CEA796E(L_27, /*hidden argument*/NULL);
		return;
	}
}
#ifdef __clang__
